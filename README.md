...
```javascript
svariancepn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-svariancepn@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-svariancepn@umd/bundle.js"></script>
```
